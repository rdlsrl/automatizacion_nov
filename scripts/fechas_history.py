...
# Cargar variables desde config.env (ruta ajustada para la carpeta script)
load_dotenv('../config.env')  # Cambia 'config.env' a '../config.env' si config.env está en la carpeta raíz
